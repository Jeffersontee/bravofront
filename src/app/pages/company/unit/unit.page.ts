...
export class UnitPage {
  ...
  goToCreate() {
    this.router.navigate([`/company/companies/${this.companyId()}/units/create`]);
  }

  goToEdit(unitId: string) {
    this.router.navigate([`/company/companies/${this.companyId()}/units/edit/${unitId}`]);
  }
  ...
  async onSave(payload: Partial<Unit>) {
    try {
      ...
      // Voltar para a lista
      this.router.navigate([`/company/companies/${this.companyId()}/units`]);
    } catch (e: any) {
